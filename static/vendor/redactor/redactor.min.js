...
(function (c) {
    ...
    b.fn = c.Redactor.prototype = {
        ...
        setSpansVerified: function () {
            ...
            c.each(f, function () {
                ...
                var j = new RegExp("<" + this.tagName, "i");
                var h = g.replace(j, "<" + e);
                j = new RegExp("</" + this.tagName, "i");
                h = h.replace(j, "</" + e);
        ...
        syncClean: function (e) {
            ...
            e = e.replace(/<inline(.*?)>([\w\W]*?)<\/inline>/gi, "<span$1>$2</span>");
        ...
        buildOptions: function () {
            ...
            if (this.opts.maxHeight) {
                e.css("max-height", this.opts.maxHeight + "px");
            }
            if (this.opts.wym) {
        ...
        buildEventKeydown: function (n) {
            ...
            if ((g && c(g).get(0).tagName === "PRE") || (m && c(m).get(0).tagName === "PRE")) {
                l = true;
                if (f === this.keyCode.DOWN) {
                    this.insertAfterLastElement(o);
                }
            }
            if (f === this.keyCode.DOWN) {
                if (g && c(g)[0].tagName === "BLOCKQUOTE") {
                    this.insertAfterLastElement(g);
                }
                if (m && c(m)[0].tagName === "BLOCKQUOTE") {
                    this.insertAfterLastElement(m);
                }
                if (g && c(g)[0].tagName === "P" && c(g).parent()[0].tagName == "BLOCKQUOTE") {
                    this.insertAfterLastElement(g, c(g).parent()[0]);
                }
                if (m && c(m)[0].tagName === "P" && g && c(g)[0].tagName == "BLOCKQUOTE") {
                    this.insertAfterLastElement(m, g);
                }
            }
            if (j && !n.shiftKey) {
                this.shortcuts(n, f);
            }
            if (j && f === 90 && !n.shiftKey && !n.altKey) {
                n.preventDefault();
            ...
            if (j && f === 65) {
                ...
                if (f != this.keyCode.LEFT_WIN && !j) {
                    this.selectall = false;
                }
            }
            if (f == this.keyCode.ENTER && !n.shiftKey && !n.ctrlKey && !n.metaKey) {
                if (this.browser("msie") && g.nodeType == 1 && (g.tagName == "TD" || g.tagName == "TH")) {
                    n.preventDefault();
                    this.bufferSet();
                ...
                if (l === true) {
                    return this.buildEventKeydownPre(n, m);
                } else {
                    if (!this.opts.linebreaks) {
                        if (o && this.opts.rBlockTest.test(o.tagName)) {
                            this.bufferSet();
                            setTimeout(
                                c.proxy(function () {
                                    var p = this.getBlock();
                                    if (p.tagName === "DIV" && !c(p).hasClass("redactor_editor")) {
                            ...
                            if (o === false) {
                                this.bufferSet();
                                var h = c("<p>" + this.opts.invisibleSpace + "</p>");
                                this.insertNode(h[0]);
                    ...
                    if (o.tagName == "BLOCKQUOTE" || o.tagName == "FIGCAPTION") {
                        return this.buildEventKeydownInsertLineBreak(n);
                    }
                }
                this.callback("enter", n);
            } else {
                if (f === this.keyCode.ENTER && (n.ctrlKey || n.shiftKey)) {
                    this.bufferSet();
                    n.preventDefault();
                    this.insertLineBreak();
                }
            }
            if (f === this.keyCode.TAB && this.opts.shortcuts) {
                return this.buildEventKeydownTab(n, l);
            }
            if (f === this.keyCode.BACKSPACE) {
                this.buildEventKeydownBackspace(m);
            }
        },
        ...
        execLists: function (j, h) {
            ...
            var n = c(q).closest("ol, ul");
            var m = false;
            if (n.length) {
                m = true;
                var p = n[0].tagName;
                if ((j === "insertunorderedlist" && p === "OL") || (j === "insertorderedlist" && p === "UL")) {
                    m = false;
                }
            }
            this.selectionSave();
            if (m) {
                ...
                c.each(
                    g,
                    c.proxy(function (v, w) {
                        if (w.tagName == "LI") {
                            var u = c(w);
                            var t = u.clone();
                            t.find("ul", "ol").remove();
                            if (this.opts.linebreaks === false) {
                                l += this.outerHtml(c("<p>").append(t.contents()));
                            } else {
                                l += t.html() + "<br>";
                            }
                            if (v == 0) {
                                u.addClass("redactor-replaced").empty();
                                r = this.outerHtml(u);
                            } else {
                                u.remove();
                            }
                ...
                html = this.$editor.html().replace(r, "</" + p + ">" + l + "<" + p + ">");
                ...
                if (n.length) {
                    if ((this.browser("msie") || this.browser("mozilla")) && q.tagName !== "LI") {
                        c(q).replaceWith(c(q).html());
                    }
                    var o = n.parent();
                    if (this.isParentRedactor(o) && this.nodeTestBlocks(o[0])) {
        ...
        formatBlock: function (e, h) {
            ...
            if (e !== "pre") {
                ...
                g = c(h).html();
                if (c.trim(g) === "") {
                    g = '<span id="selection-marker-1"></span>';
                }
            }
            if (h.tagName === "PRE") {
                e = "p";
            ...
            if (this.opts.linebreaks === true && e === "p") {
                c(h).replaceWith(c("<div>").append(g).html() + "<br>");
            } else {
                var f = c("<" + e + ">").append(g);
                c(h).replaceWith(f);
            }
        ...
        inlineSetMethods: function (j, h, e, l) {
            var g = c(h).parent(),
                f;
            if (g && g[0].tagName === "INLINE" && g[0].attributes.length != 0) {
                f = g;
                c(h).replaceWith(c(h).html());
            } else {
                f = c("<inline>").append(c(h).contents());
                c(h).replaceWith(f);
            }
            c(f)[j](e, l);
            return f;
        ...
        inlineEachNodes: function (j) {
            ...
            c.each(
                ...
                c.proxy(function (l, m) {
                    if (!h && m.tagName !== "INLINE") {
                        if (m.parentNode.tagName === "INLINE" && !c(m.parentNode).hasClass("redactor_editor")) {
                            m = m.parentNode;
                        } else {
                            return;
                        }
        ...
        insertAfterLastElement: function (e, f) {
            ...
            if (this.isEndOfElement()) {
                if (this.opts.linebreaks) {
                    var h = c("<div>").append(c.trim(this.$editor.html())).contents();
                    if (this.outerHtml(h.last()[0]) != this.outerHtml(e)) {
                        return false;
                    }
                } else {
                ...
                this.bufferSet();
                if (this.opts.linebreaks === false) {
                    var g = c(this.opts.emptyHtml);
                    c(e).after(g);
                    this.selectionStart(g);
                } else {
                    var g = c('<span id="selection-marker-1">' + this.opts.invisibleSpace + "</span>", this.document)[0];
                    c(e).after(g);
                    c(g).after(this.opts.invisibleSpace);
                    this.selectionRestore();
        ...
        getNodes: function (g, e) {
            ...
            var f = [],
                j = [];
            var h = this.document.getSelection();
            if (!h.isCollapsed) {
                f = this.getRangeSelectedNodes(h.getRangeAt(0));
            }
            c.each(
                f,
                c.proxy(function (m, n) {
                    if (this.opts.iframe === false && c(n).parents("div.redactor_editor").length == 0) {
                        return false;
                    }
                    if (typeof e === "undefined") {
                        if (c.trim(n.textContent) != "") {
                            j.push(n);
                        }
                    } else {
                        if (n.tagName == e) {
        ...
        linkInsert: function (e, h, f, g) {
            this.selectionRestore();
            if (h !== "") {
                if (this.insert_link_node) {
                    this.bufferSet();
                    c(this.insert_link_node).text(h).attr("href", f);
                    if (g !== "") {
                        c(this.insert_link_node).attr("target", g);
                    } else {
                        c(this.insert_link_node).removeAttr("target");
                    }
                    this.sync();
                } else {
                    this.exec("inserthtml", e);
                }
            }
            setTimeout(
                c.proxy(function () {
        ...
        imageSave: function (h) {
            ...
            if (n === "left") {
                f.css({ float: "left", margin: "0 " + this.opts.imageFloatMargin + " " + this.opts.imageFloatMargin + " 0" });
            } else {
                if (n === "right") {
                    f.css({ float: "right", margin: "0 0 " + this.opts.imageFloatMargin + " " + this.opts.imageFloatMargin + "" });
                } else {
        ...
        imageResizeHide: function (h) {
            if (h !== false && c(h.target).parent().length != 0 && c(h.target).parent()[0].id === "redactor-image-box") {
                return false;
            }
            ...
            var g = f[0].style.margin;
            if (g != "0px") {
                f.find("img").css("margin", g);
                f.css("margin", "");
            }
        ...
        imageThumbClick: function (g) {
            var f = '<img id="image-marker" src="' + c(g.target).attr("rel") + '" alt="' + c(g.target).attr("title") + '" />';
            if (this.opts.paragraphy) {
                f = "<p>" + f + "</p>";
            }
        ...
        imageInsert: function (f, g) {
            ...
            if (f !== false) {
                ...
                this.execCommand("inserthtml", e, false);
                var h = c(this.$editor.find("img#image-marker"));
                if (h.length) {
                    h.removeAttr("id");
                } else {
                    h = false;
                ...
                this.sync();
                g !== true && this.callback("imageUpload", h, f);
            }
            this.modalClose();
            this.observeImages();
        },
        ...
        s3executeOnSignedUrl: function (e, g) {
            var f = new XMLHttpRequest();
            f.open("GET", this.opts.s3 + "?name=" + e.name + "&type=" + e.type, true);
            f.overrideMimeType("text/plain; charset=x-user-defined");
            f.onreadystatechange = function (h) {
                if (this.readyState == 4 && this.status == 200) {
                    c("#redactor-progress").fadeIn();
                    g(decodeURIComponent(this.responseText));
                } else {
                    if (this.readyState == 4 && this.status != 200) {
                    }
                }
    ...
    c.Redactor.fn.formatLinkify = function (x, u, m, r, j) {
        var s = /(^|&lt;|\s)(www\..+?\..+?)(\s|&gt;|$)/g,
            ...
            w = /^.*(youtu.be\/|u\/\w\/|embed\/|watch\?v=|\&v=)([^#\&\?]*).*/,
        ...
        while (l--) {
            ...
            if (h.nodeType === 3) {
                ...
                if (r && p) {
                    ...
                    if (p.match(w)) {
                        p = p.replace(w, o + "//www.youtube.com/embed/$2" + g);
                        c(h).after(p).remove();
                    } else {
                        if (p.match(t)) {
                ...
                if (u && p && (p.match(s) || p.match(q))) {
                    ...
                    p = p
                        ...
                        .replace(/</g, "&lt;")
                        .replace(/>/g, "&gt;")
                        .replace(s, '$1<a href="' + x + '$2">' + f + "</a>$3")
                        .replace(q, '$1<a href="$2">' + f + "</a>$5");
                    c(h).after(p).remove();
                }
            } else {
